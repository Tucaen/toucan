...
| Project file reads               | [`src/main/file-view.ts`](../src/main/file-view.ts)                                                                                                                                                                    | Fail-closed, size-capped reads of one file inside a registered project or worktree, plus directory-level change watching, behind `FileView` for the canvas's file node. IPC shape checks live in [`file-view-ipc.ts`](../src/main/file-view-ipc.ts).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
