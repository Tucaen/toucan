...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Persisted domain contracts       | [`src/shared/workspace.ts`](../src/shared/workspace.ts), [`terminal.ts`](../src/shared/terminal.ts), [`shell.ts`](../src/shared/shell.ts), [`agent.ts`](../src/shared/agent.ts), [`worktree.ts`](../src/shared/worktree.ts), [`conversation.ts`](../src/shared/conversation.ts)                            | Cross-process data shapes, validation-independent domain rules, and stable identities.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
- **Preload interfaces** are the privilege seam. Each `window.*Api` contract lives in
  ...
  transport change should be possible behind `window.workspaceApi`, `window.agentApi`,
