...
| Canvas orchestration             | [`src/renderer/src/App.tsx`](../src/renderer/src/App.tsx), [`canvas-workspace.ts`](../src/renderer/src/canvas-workspace.ts)                                                                                            | Compose workspace modules, projects, worktrees, React Flow nodes, recently closed sessions, and conversion between persisted and live nodes.                                                                                                                                                     |
