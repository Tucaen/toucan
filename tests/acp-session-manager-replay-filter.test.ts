...
const REAL_STOP_HOOK_FEEDBACK = '<task-notification>\n'
...
const REAL_BACKGROUND_COMMAND_NOTIFICATION = '<task-notification>\n'
...
test('does not flag real assistant/user prose that merely discusses these tags mid-message', () => {
  const text = 'Sure - internal hooks sometimes emit blocks like <task-notification> or '
