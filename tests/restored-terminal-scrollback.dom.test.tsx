  ...
  Object.defineProperty(window, 'terminalApi', {
    ...
    value: {
      ...
      scrollback: vi.fn().mockResolvedValue({
        sessionId: 'session', incarnationId: 'retired-incarnation', data: '\x1b[32mkept output\x1b[0m',
        capturedAt: 100, truncated: true, incomplete: true
      }),
      copyText: vi.fn()
    }
  })

  render(<ReactFlowProvider><TerminalNode id="node" type="terminalNode" selected={false} dragging={false} zIndex={0} isConnectable={false} positionAbsoluteX={0} positionAbsoluteY={0} data={{
    kind: 'terminal', sessionId: 'session', terminalLiveness: 'unverifiable', label: 'Terminal 1',
    projectId: 'project', projectName: 'Project', projectPath: '/project', projectColor: '#fff',
    workingDirectory: '/project', focusMode: false, dormant: true, launchMode: 'resume',
